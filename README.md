Junior Offensive Security Specialist | Purple Team Focus | Python Developer

</div>
🎯 Current Directives

    🛡️ Training for: CPTS (Hack The Box Certified Penetration Testing Specialist)

    ⚙️ Mastering: Active Directory Enumeration & Exploitation (Impacket, BloodHound)
...
Offensive Operations & Scripting
...
Core Development & Web Stack (Code Review Context)
...
📡 Featured Projects
    ...
    🐍 ucha-scanner: Multithreaded network enumerator with banner grabbing and directory fuzzing built from scratch in Python.
